                ...
                <tbody className="divide-y divide-gray-200">
                  {data?.data.map((question, index) => (
                    <tr key={question.id} className="hover:bg-gray-50 transition">
                      ...
                      {isAuthorized && (
                        <td className="px-6 py-4 text-center">
                          <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${question.isPublished
                ...
                {Array.from({ length: data.totalPages }, (_, i) => i + 1)
                  ...
                  .map((p, i, arr) => (
                    <span key={p} className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() => setPage(p)}
                        className={`px-4 py-2 rounded-lg transition ${page === p ? "bg-navy-600 text-white" : "bg-white border border-gray-300 hover:bg-gray-50"
                          }`}
                      >
                        {p}
                      </button>
